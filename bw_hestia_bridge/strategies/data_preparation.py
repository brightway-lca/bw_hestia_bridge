...
def clean_irrelevant_emissions(obj: dict) -> dict:
    """
    Removed [`not relevant`](https://www-staging.hestia.earth/schema/Emission#methodTier) emissions from the dataset.
    ...
    """
    obj["emissions"] = [
        node for node in obj["emissions"] if node.get("methodTier") != "not relevant"
    ]
    return obj
